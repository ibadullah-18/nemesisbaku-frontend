  ...
  return (
    <div className="nb-merch nb-merch__form">
      ...
      <div className="mb-7 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <button type="button" onClick={loadAll} disabled={saving} className="flex h-12 items-center justify-center gap-2 rounded-[16px] bg-zinc-950 px-5 text-sm font-extrabold text-white disabled:opacity-60"><FiRefreshCw /> Yenilə</button>
      </div>
      ...
      >
        ...
        <aside className="space-y-5">
          <section className="sticky top-5 rounded-[28px] bg-white p-5 shadow-[0_18px_55px_rgba(0,0,0,0.04)] md:p-6">
            ...
            >
              <FiSave />
              {saving ? "Yadda saxlanılır…" : isEdit ? "Dəyişiklikləri saxla" : "Bölmə yarat"}
            </button>
          </section>
        </aside>
      </form>
